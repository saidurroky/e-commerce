...
<link rel="stylesheet" href="<?php echo e(asset('/front/')); ?>/css/jquery.countdown.css" />
<!-- Custom Theme files -->
<!--webfont-->
<link href='http://fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900' rel='stylesheet' type='text/css'>
<script type="text/javascript" src="<?php echo e(asset('/front')); ?>/js/jquery-1.11.1.min.js"></script>
<!-- dropdown -->
<script src="<?php echo e(asset('/front')); ?>/js/jquery.easydropdown.js"></script>
<!-- start menu -->
<link href="<?php echo e(asset('/front')); ?>/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="<?php echo e(asset('/front')); ?>/js/megamenu.js"></script>
...
<link rel="stylesheet" href="<?php echo e(asset('/front')); ?>/css/etalage.css">
<script src="<?php echo e(asset('/front')); ?>/js/jquery.etalage.min.js"></script>
<script>
